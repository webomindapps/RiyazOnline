                        ...
                        <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group animated delay-1">
                                            ...
                                            <input class="form-control datepicker hasDatepicker" id="dob"
                                                ...
                                                max="2025-05-26" required value="{{$student->dob}}">
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <p style="color:#ec1c24;font-weight:600;">Currrently Staying</p>
                                        ...
                                        <label class="mt-2">State<span style="color:red">*</span></label>
                                        ...
                                        <label class="mt-2">City<span style="color:red">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex justify-content-between">
                                            <p style="color:#ec1c24;font-weight:600;">Originally From </p>
                                            <div class="">
                                        ...
                                        <select name="p_country_id" required id="p_country"
                                            style="border: 1px solid #e4e3e7;width:100%;border-radius: 7px;box-shadow: none;padding: 14px 15px;font-size: 14px;border: 1px solid #ff430442;color: #656565;background: #fff;">
                                        ...
                                        <select name="p_state_id" required id="p_state"
                                            style="border: 1px solid #e4e3e7;width:100%;border-radius: 7px;box-shadow: none;padding: 14px 15px;font-size: 14px;border: 1px solid #ff430442;color: #656565;background: #fff;">
                                            <option value="">Select State</option>
                                        </select>
                                        <label class="mt-2">City<span style="color:red">*</span></label>
                                        ...
                                        <textarea id="permanent_address" name="permanent_address" class="form-control custom-control" required
                                            style="border-radius: 7px; border: 1px solid #ff430442; padding-left:5px;">{{ $student->permanent_address }}</textarea>
                                    </div>
                                    @if ($student->age != 'Adult')
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" type="text" name="father_name"
                                                id="father_name" onkeypress="return isalpha(event)" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" type="text" name="mother_name"
                                                id="mother_name" onkeypress="return isalpha(event)" required>
    ...
    @push('scripts')
        <script>
            function validate_form() {
                ...
                if (f_name === "" || l_name === "" || email == "" || phone == "" || file == "" || dob == "" || age == "" ||
                    gender == "" ||
                    whatsapp_no == "") {
            ...
            $(document).ready(function() {
                $('#sameAsCurrent').on('change', function() {
                    if ($(this).is(':checked')) {
                        $("#p_country").val($("#country").val());
                        // Copy State
                        $("#p_state").html($("#state").html()); // clone options
            ...
            $('#p_country').on('change', function() {
                ...
                if (country_id) {
                    $.ajax({
                        ...
                        dataType: 'json',
                        success: function(data) {
                            $('#p_state').empty().append(
                                '<option selected value="">Select State</option>');
                            $.each(data, function(key, value) {
                                $('#p_state').append('<option value="' + value.id + '">' + value
                                    .name + '</option>');
                            });
                        }
                    });
                } else {
                    $('#p_state').empty().append('<option selected value="">Select State</option>');
                }
            });
        </script>
    @endpush
