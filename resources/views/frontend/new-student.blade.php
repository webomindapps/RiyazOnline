                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group animated delay-1">
                                ...
                                <input type="text"
                                    ...
                                    minlength="10"
                                    maxlength="15" name="phone" class="form-control" placeholder="Mobile Number"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group animated delay-1">
                                ...
                                <input type="text"
                                    ...
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    minlength="10"
                                    maxlength="15" name="contact_no2" class="form-control"

                                    placeholder="Alternative Mobile Number" pattern="[0-9]{10,15}"
