<x-guest-layout>
    ...
    <section class="final-step-card-section">
        ...
        <div class="final-card row g-0 ck">
                ...
                <form action="{{ route('payment.initiate') }}" method="post" class="order-summary">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 text-end">
                            ...
                            <p class="fw-semibold">₹ {{ $course->old_student_fees }}</p>
                    ...
                    <div class="row">
                        <div class="col-8">
                            <h5>Registration Fee (One-time)</h5>
                        </div>
                        <div class="col-4 text-end">
                            <p class="fw-semibold">₹ {{ $course->new_student_fees-$course->old_student_fees }}</p>
                        </div>
                    </div>
