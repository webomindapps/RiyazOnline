                                        ...
                                        ">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td colspan="4" class="dark bdtop">
                                                                                    ...
                                                                                    {{ date('d-m-Y', strtotime($studentCourse->paid_date)) }}
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td rowspan="{{$studentCourse->penalty_amount ? 5 : 4 }}" class="dark">
                                                                            ...
                                                                            @if($studentCourse->penalty_amount)
                                                                                <tr>
                                                                                    <td colspan="7"
                                                                                        class="dark bdright">
                                                                                        Penalty
