<x-app-layout>
    <div class="m-3 bg-white">
        <x-admin.breadcrumb title="New Student Details" isBack="{{ true }}" />
            ...
            <form method="POST" class="formSubmit" action="{{ route('admin.student.create') }}"
                ...
                <div class="row mb-4">
                    ...
                    <x-forms.input label="Contact" type="number" name="phone" id="phone" :required="true"
                        size="col-lg-4 mt-4" :value="old('phone')" />
                    <x-forms.input label="Alternate Contact" type="number" name="phone_2" id="phone_2"
                        :required="true" size="col-lg-4 mt-4" :value="old('phone_2')" />
                    ...
                    <x-forms.input label="City" type="text" name="city" id="city" :required="false"
                        size="col-lg-4 mt-4" :value="old('city')" />
                    ...
                    <x-forms.input label="Father's name" type="text" name="father_name" id="father_name"
                        :required="false" size="col-lg-6 mt-4" :value="old('father_name')" />
                    <x-forms.input label="Mother's name" type="text" name="mother_name" id="mother_name"
                        :required="false" size="col-lg-6 mt-4" :value="old('mother_name')" />
                    <x-forms.textarea label="Current Address" type="text" name="current_address"
                        id="current_address" :required="false" size="col-lg-6 mt-4" :value="old('current_address')" />
                    <x-forms.textarea label="Permanent Address" type="text" name="permanent_address"
                        id="permanent_address" :required="false" size="col-lg-6 mt-4" :value="old('permanent_address')" />
                    <x-forms.input label="Emergency Contact Person Name" type="text" name="emg_contact_person"
                        id="emg_contact_person" :required="false" size="col-lg-5 mt-4" :value="old('emg_contact_person')" />
                    <x-forms.input
                        ...
                        size="col-lg-7 mt-4" :value="old('emg_contact_no')" />
                    ...
                    <x-forms.input label="Reminder Date" type="date" name="reminder_date" id="reminder_date"
                        :required="false" size="col-lg-6 mt-4" :value="old('reminder_date')" />
                    <x-forms.textarea label="Reminder" type="text" name="reminder" id="reminder"
                        :required="false" size="col-lg-12 mt-4" :value="old('reminder')" />
                </div>
