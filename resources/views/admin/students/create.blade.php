            ...
            <form method="POST" class="formSubmit" action="{{ route('admin.student.create') }}"
                ...
                <div class="row mb-4">
                    ...
                    <x-forms.textarea label="Current Address" type="text" name="current_address" id="current_address"
                        :required="false" size="col-lg-6 mt-4" :value="old('current_address')" />
                    ...
                    <x-forms.input label="Emg Contact Person" type="text" name="emg_contact_person"
                        id="emg_contact_person" :required="false" size="col-lg-6 mt-4" :value="old('emg_contact_person')" />
                    <x-forms.input label="Emg Contact No" type="number" name="emg_contact_no" id="emg_contact_no"
                        :required="true" size="col-lg-6 mt-4" :value="old('emg_contact_no')" />
                    <x-forms.input label="Emg Contact Person Relation" type="text" name="emg_relation"
                        id="emg_relation" :required="false" size="col-lg-6 mt-4" :value="old('emg_relation')" />
                    ...
                    <x-forms.textarea label="Office Address" type="text" name="office_address"
                        id="office_address" :required="false" size="col-lg-12 mt-4" :value="old('office_address')" />
