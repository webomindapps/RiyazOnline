<x-app-layout>
    <div class="m-3 bg-white">
        <x-admin.breadcrumb title="Add Template" isBack="{{ true }}" />
        <div class="form-card px-3 bg-white">
            ...
            @endif
            <form method="POST" class="formSubmit" action="{{ route('admin.templates.store') }}"
                enctype="multipart/form-data">
                @csrf
                <div class="row mb-4">
                    <x-forms.input label="Title" type="text" name="title" id="title" :required="true"
                        size="col-lg-8 mt-4" :value="old('title')" />
                    ...
                    <x-forms.textarea label="Content" type="text" name="content" id="content" :required="true"
                        size="col-lg-12 mt-4" :value="old('content')" />
                </div>
